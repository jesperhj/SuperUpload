...
module Thin
  ...
  class Connection < EventMachine::Connection
    ...
    def receive_data(data)
      #########################################################################
      # Store file with info for IE
      #########################################################################
      form_id_match = data.match(/form-data; name="file-(.*)";/)
      filename_match = data.match(/filename="(.*)"/)
      
      if !form_id_match.nil? && !filename_match.nil?
        form_id  = form_id_match[1]
        filename = filename_match[1]
        
         if !@request.tempfile_path.nil?
           info = {
             :size     => @request.content_length,
             :path     => @request.tempfile_path,
             :filename => filename
           }
